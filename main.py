...
if x >= age_summ2[0] and x <= age_summ2[1]:
  summ_tickets.append(summ2)
if x >= age_summ3[0] and x <= age_summ3[1]:
    summ_tickets.append(summ3)
if c > 3:
  print("Сумма вашего заказа:",sum(summ_tickets)*0,9)
print("Сумма вашего заказа:",sum(summ_tickets))